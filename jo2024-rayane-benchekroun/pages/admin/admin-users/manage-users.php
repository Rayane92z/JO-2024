    ...
    <header>
        <nav>
            ...
            <ul class="menu">
                ...
                <li><a href="../admin-sports/manage-sports.php">Gestion Des Sports</a></li>
                <li><a href="../admin-places/manage-places.php">Gestion Des Lieux</a></li>
                <li><a href="../admin-events/manage-events.php">Gestion Des Calendrier</a></li>
                <li><a href="../admin-countries/manage-countries.php">Gestion Des Pays</a></li>
                <li><a href="./manage-gender.php">Gestion Des Genres</a></li>
                <li><a href="./manage-athletes.php">Gestion Des Athlètes</a></li>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    // Possibilité d'utiliser a href mais je prefère faire appel à une fonction javascript
